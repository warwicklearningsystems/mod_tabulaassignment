...
/**
 * Search area for mod_tabulaassignment activities.
 *
...
namespace mod_tabulaassignment\search;
...
class activity extends \core_search\base_activity {
    ...
    public function get_doc_url(\core_search\document $doc) {
        // Get correct URL to section that contains tabulaassignment, from course format.
        ...
        // Add the ID of the tabulaassignment to the section URL.
        $url->set_anchor('module-' . $cminfo->id);
        return $url;
    }

    /**
     * Overwritten as tabulaassignments are displayed in-course. Link to the course.
     *
     * @param \core_search\document $doc
     * @return \moodle_url
     */
    public function get_context_url(\core_search\document $doc) {
        return new \moodle_url('/tabulaassignment/view.php', array('id' => $doc->get('courseid')));
